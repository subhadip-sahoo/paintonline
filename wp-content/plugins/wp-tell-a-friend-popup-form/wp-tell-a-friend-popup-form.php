...
function TellAFriend()
{
    ...
    <div class="product-details-social">
        <a href='javascript:TellAFriend_OpenForm("TellAFriend_BoxContainer","TellAFriend_BoxContainerBody","TellAFriend_BoxContainerFooter");' class="add-to-email"><?php echo get_option('TellAFriend_Caption'); ?></a>
    </div>
