...
class Woocommerce_product_filter_category extends WP_Widget{
	...
	public function widget($args, $instance){ // Frontend widget form
		global $codenegar_wcpf;
		if (!is_tax( 'product_cat' ) && !is_post_type_archive('product') && !is_tax( 'product_tag' ) && !$codenegar_wcpf->helper->is_product_archive()&& !$codenegar_wcpf->helper->is_product_archive()) return; // Not on product page - return
