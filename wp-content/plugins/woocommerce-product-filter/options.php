...
<div id="poststuff" class="metabox-holder" >
	...
	<input type="text" id="custom_taxonomies_list" size="90" placeholder="product_brand, my_custom_tax" name="custom_taxonomies_list" value="<?php echo $codenegar_product_filter_options['custom_taxonomies_list']; ?>" style="background-image: none; background-position: 0% 0%; background-repeat: repeat repeat;">
	<br />
	<br />
	<label for="wrapper_selector"><?php _e('Override products wrapper', $codenegar_wcpf->text_domain); ?>:<span id="postform"></span></label>
	<input type="text" size="90" id="wrapper_selector"  placeholder="#products_list" name="wrapper_selector" value="<?php echo $codenegar_product_filter_options['wrapper_selector']; ?>" style="background-image: none; background-position: 0% 0%; background-repeat: repeat repeat;">
	<br />
	<br />
	<label for="custom_areas"><?php _e('Custom areas to update', $codenegar_wcpf->text_domain); ?>:<span id="postform"></span></label>
	<input type="text" size="90" id="custom_areas"  placeholder=".pagination, .result-count" name="custom_areas" value="<?php echo $codenegar_product_filter_options['custom_areas']; ?>" style="background-image: none; background-position: 0% 0%; background-repeat: repeat repeat;">
	<br />
	<br />
   	<label for="custom_css"><?php _e('Custom CSS', $codenegar_wcpf->text_domain); ?>:<span id="postform"></span></label>
	<textarea cols="90" rows="5" id="custom_css" spellcheck='false' name="custom_css" style="background-image: none; background-position: 0% 0%; background-repeat: repeat repeat;"><?php echo $codenegar_product_filter_options['custom_css']; ?></textarea>
	<br />
	<br />
    <label for="custom_js"><?php _e('Custom JavaScript', $codenegar_wcpf->text_domain); ?>:<span id="postform"></span></label>
	<textarea cols="90" rows="5" id="custom_js" spellcheck='false' name="custom_js" style="background-image: none; background-position: 0% 0%; background-repeat: repeat repeat;"><?php echo $codenegar_product_filter_options['custom_js']; ?></textarea>
	<br />
	<br />
    
	<label for="create-sidebar"><?php _e('Sidebars', $codenegar_wcpf->text_domain); ?>:<span id="postform"></span></label>
